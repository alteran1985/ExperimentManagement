...
import extra.ConstraintAttribute;
import extra.FMComposerManager;
import extra.FeatureModelAnalyzer;
import extra.FeatureStatus;
import extra.PropertyConstants;
import extra.RenamingsManager;
...
public class FeatureModel implements PropertyConstants {
	...
	public final List<Constraint> constraints = new LinkedList<Constraint>();
	...
	private final FeatureModelAnalyzer analyzer = new FeatureModelAnalyzer(this);
